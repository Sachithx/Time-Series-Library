...
configs=(
    # pred_len 96 - small model, low dropout, fixed patch_size=12
    "96:3:8:256:2:1:32:0.01:0.1:20:20:0.2:0.1:0.4:20:10:1:96:1"
    
    # pred_len 192 - 4 heads, 2 global layers, high threshold, no monotonicity
    "192:3:8:256:2:1:32:0.01:0.1:20:20:0.2:0.15:0.4:20:10:1:96:1"
    
    # pred_len 336 - medium model, small patches (4)
    "336:3:16:256:4:1:32:0.01:0.2:20:20:0.2:0.1:0.4:20:15:1:96:1"
    
    # pred_len 720 - same as 336
    "720:3:16:256:4:1:32:0.01:0.2:20:20:0.2:0.1:0.4:20:15:1:96:1"
)
...
for config in "${configs[@]}"; do
    ...
    echo "Starting experiment on GPU $gpu_id: pred_len=$pred_len, dim=$dim, heads=$heads, layers=$layers, batch_size=$batch_size, patch_size=$patch_size"
...
wait
echo "All ETTm2 experiments completed!"
